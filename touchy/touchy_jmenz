...
class touchy:
        ...
        def setfont(self):
                ...
                for i in ["1", "2", "3", "4", "5", "6", "7",
                          ...
                          "home_all", "unhome_all", "home_x", "unhome_x", "home_z", "unhome_z",
                          "fo", "so", "rpm", "mv", "manual_mode", "scrolling",
                          "override_limits",
        ...
        def wheelFoUpdate(self, d):
                if self.hal.wheelreset:
                    ...
                    if self.fo_val > max_feed_override: self.fo_val = max_feed_override
        ...
        def wheelSoUpdate(self, d):
                if self.hal.wheelreset:
                    ...
                    if self.so_val > max_spindle_override: self.so_val = max_spindle_override
        ...
        def wheelRPMUpdate(self, d):
                ...
                if self.hal.wheelreset:
                   self.spindle_speed_val = self.spindle_default_speed
                    ...
                    if self.spindle_speed_val <= 0 : self.spindle_speed_val = 0
                    if self.spindle_speed_val > self.spindle_max_speed :
        ...
        def wheelMvUpdate(self, d):
                if self.hal.wheelreset:
                    ...
                    if self.mv_val > self.velocity_limit: self.mv_val = self.velocity_limit
                    if d != 0:
                        self.linuxcnc.max_velocity(self.mv_val)
        ...
        def wheelJogUpdate(self, d):
                if self.hal.wheelreset:
                    ...
                    if self.jog_vel_val < 0: self.jog_vel_val = 0
                    if self.jog_vel_val > self.velocity_limit: self.jog_vel_val = self.velocity_limit
                    if d != 0:
                        self.linuxcnc.continuous_jog_velocity(self.jog_vel_val)
